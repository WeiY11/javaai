...
public class ReportExportService {
    ...
    public ReportExportService(AnalysisProperties properties,
    ...
    public String exportMarkdown(List<AnalysisResult> results, String reportTitle) {
        try {
            ...
            for (AnalysisResult result : results) {
                ...
                sb.append("- **分析时间**: ").append(result.getAnalyzedAt().format(
                    DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))).append("\n");
    ...
    public String exportPdf(List<AnalysisResult> results, String reportTitle) {
        try {
            ...
            document.add(new Paragraph("生成时间: " + LocalDateTime.now().format(
                DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")), metaFont));
            ...
            for (AnalysisResult result : results) {
                ...
                document.add(new Paragraph(
                    "分析时间: " + result.getAnalyzedAt().format(
                        DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))
                    + "  |  AI模型: " + result.getProvider()
                    + "  |  文件大小: " + formatSize(result.getFileSize()),
                    metaFont));
                document.add(Chunk.NEWLINE);
