...
public class ConversationExportService {
  ...
  public String exportAsMarkdown(Long conversationId) {
    ...
    sb.append("# ")
        .append(conv.getTitle() != null ? conv.getTitle() : "Conversation " + conv.getId())
        .append("\n\n");
    sb.append("> Model: ")
        .append(conv.getModelProvider() != null ? conv.getModelProvider() : "unknown")
        .append("\n");
  ...
  public String exportAsJson(Long conversationId) {
    ...
    try {
      return objectMapper
          ...
          .writeValueAsString(java.util.Map.of("conversation", conv, "messages", messages));
    } catch (Exception e) {
