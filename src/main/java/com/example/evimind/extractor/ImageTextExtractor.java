...
public class ImageTextExtractor implements FileContentExtractor {
  ...
  private static final Set<String> SUPPORTED_EXTENSIONS =
      Set.of(".png", ".jpg", ".jpeg", ".tiff", ".tif", ".bmp");
    ...
    try {
      ...
      if (text == null || text.isBlank()) {
        return ExtractionResult.success(
            "[图片OCR未识别到文本内容]", "text", Map.of("ocrEngine", "tesseract", "language", language));
      }
      ...
      return ExtractionResult.success(
          content, "text", Map.of("ocrEngine", "tesseract", "language", language));
