...
/**
 * 标记需要审计日志的方法。 通过 AOP 拦截，自动记录操作到 audit_log 表。
 *
 * <p>用法： @Auditable(action = "DOCUMENT_UPLOAD", resourceType = "DOCUMENT") public void
 * uploadDocument(...) { ... }
 */
...
public @interface Auditable {
  ...
  /** SpEL 表达式，用于从方法参数中提取资源 ID。 例如："#documentId" 或 "#args[0]" */
