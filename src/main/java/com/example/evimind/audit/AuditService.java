...
/**
 * 操作审计日志服务。
 * 记录用户的关键操作（文档上传/删除、知识库创建/删除、权限变更等）。
 */
@Slf4j
@Service
...
public class AuditService {
    ...
    public void log(String action, String resourceType, Long resourceId, Map<String, Object> detail) {
        try {
            ...
            // 审计日志记录失败不应影响主流程
            log.warn("Failed to write audit log: action={}, resource={}/{}, error={}",
     ...
     */
    @Async
    public void logAsync(String action, String resourceType, Long resourceId, Map<String, Object> detail) {
     ...
     * 分页查询审计日志。
     */
    public IPage<AuditLog> queryLogs(int page, int size, Long userId, String action, String resourceType) {
