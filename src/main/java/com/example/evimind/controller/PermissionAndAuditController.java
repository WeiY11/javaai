...
public class PermissionAndAuditController {
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getPermissions(@PathVariable Long docId) {
    ...
    public ResponseEntity<ApiResponse<Void>> grantPermission(
        ...
        documentPermissionService.requirePermission(docId, currentUserId, DocumentPermissionService.PERM_ADMIN);
        documentPermissionService.grantPermission(docId, userId, permissionType, currentUserId);

        auditService.log("PERMISSION_GRANT", "DOCUMENT", docId,
    ...
    public ResponseEntity<ApiResponse<Void>> revokePermission(
        ...
        auditService.log("PERMISSION_REVOKE", "DOCUMENT", docId,
                Map.of("targetUserId", userId, "permissionType", permissionType));
