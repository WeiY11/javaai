...
public class FileController {
  ...
  @GetMapping("/content")
  public ApiResponse<Map<String, Object>> getFileContent(@RequestParam("path") String filePath)
      throws IOException {
    ...
    ExtractionResult extraction =
        fileExtractorService.extractFile(target, analysisProperties.getMaxContentSize());
  ...
  public Flux<String> analyzeFile(
    ...
    return chatService
        .streamChat(provider, prompt, sessionId)
