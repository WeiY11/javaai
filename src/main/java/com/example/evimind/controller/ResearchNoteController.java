...
public class ResearchNoteController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<ApiResponse<ResearchNote>> update(
      @PathVariable Long id, @RequestBody ResearchNote note) {
  ...
  public ResponseEntity<ApiResponse<List<ResearchNote>>> list(
    ...
    return ResponseEntity.badRequest()
        .body(ApiResponse.error("Must provide chunkId or documentId"));
  }
}
