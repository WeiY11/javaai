...
public class SchedulerController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<ScheduledTask>> createTask(@RequestBody Map<String, Object> body) {
        ...
        auditService.log("SCHEDULER_CREATE", "SCHEDULED_TASK", task.getId(),
